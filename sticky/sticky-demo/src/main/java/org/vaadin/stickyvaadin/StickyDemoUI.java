...
public class StickyDemoUI extends UI {
	...
	@VaadinServletConfiguration(productionMode = false, ui = StickyDemoUI.class, widgetset = "org.vaadin.stickyvaadin.demo.DemoWidgetSet")
	...
	protected void init(VaadinRequest request) {
		...
		final NativeSelect spacingSelect = new NativeSelect("Select top spacing for sticky panel",
				getSpacingContainer());
